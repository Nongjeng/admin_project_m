    ...
    <div class=" card w-100 h-100 rounded-0 border-0 rounded-top-5">
        ...
        <div class=" d-flex align-items-end fixed-bottom p-3 flex-column">
            <div class=" d-flex justify-content-between w-100 mb-3">
                ...
                <p class="m-0 display-4 fw-bolder">80 <span class=" fs-5 fw-medium ">บาท</span></p>
            </div>
            <div class=" d-flex justify-content-between w-100">
                <button class=" btn btn-outline-dark btn-lg rounded-4 px-5">ย้อนกลับ</button>
                <button class="btn btn-green-500 btn-lg rounded-4 px-4">ยืนยันคำสั่งซื้อ</button>
            </div>
        </div>
    </div>
