<div class="  px-2 py-3 fw-medium fs-4 w-100" style="box-shadow: 0px -1px 5px 6px rgba(0,0,0,0.19) inset;">
    <div class=" d-flex justify-content-around">
        <a  href="?page=home" class=" text-decoration-none text-dark">
        ...
        <a href="?page=list" class=" text-decoration-none text-dark">
            <div class=" vstack justify-content-center">
        ...
        <a  href="?page=store" class=" text-decoration-none text-dark">
            <div class=" vstack justify-content-center">
        ...
        <a href="?page=profile" class=" text-decoration-none text-dark">
            <div class=" vstack justify-content-center">
